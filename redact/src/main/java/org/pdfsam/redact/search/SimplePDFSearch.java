...
public class SimplePDFSearch {
    ...
    private static final String INDEX_DIR = "C:/src/resources/index";
    private static final int DEFAULT_RESULT_SIZE = 100;

    public static void main(String[] args) throws IOException, ParseException {

        File pdfFile = new File("C:/src/resources/SamplePDF.pdf");
        ...
        int result = searcher.findByContent("Pariyani", DEFAULT_RESULT_SIZE);
        print(result);
        searcher.close();
    }
